...
export default function Faqs() {
  return (
    <div className="pageColumn">
      ...
      <p className="text-xl">
        The ceremony and cocktail hour will be outdoors, weather permitting, and
        the reception will be indoors (with AC). Be prepared for humid weather
        and for walking on grass.
      </p>
      ...
      <p className="text-xl">
        We will have 2 return shuttle trips, one at 9:00pm, and a second at the
        end of the event at 10:30pm.
      </p>
      ...
      <p className="text-xl">
        Please consult the{" "}
        <Link href="../juliamiller/travel">travel and lodging materials.</Link>
      </p>
      ...
      <p className="text-xl">
        ...
        think we have forgotten anyone, or if you have any questions, feel free
        to reach out.
      </p>
