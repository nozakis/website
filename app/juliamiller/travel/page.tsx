    ...
    <div>
      <div className="center">
        ...
        <p className="text-xl">
          ...
          accommodations in the Worcester area. There are Airbnbs in the area,
          and below are a few other good hotel options.
        </p>
        <br />
        <p className="text-xl">
          Courtyard Worcester
        ...
        <p className="text-xl">
          ...
          <br />
          However, if you&apos;re car-averse or public transit-inclined, the
